    ...
    <>
      <div className="mt-16 w-full bg-white">
        <div className="lg:mx-[5rem] mx-0">
          ...
          <h1 className="text-center lg:text-5xl md:text-4xl text-3xl font-bold leading-[72px]">
            Giỏ hàng
          </h1>
          ...
          {show ? (
              ...
              {show && (
                <tfoot>
                  <tr>
                    ...
                    <th className="text-center align-middle lg:text-[20px] md:text-base text-sm text-primary">
                    ...
                    <th colSpan={2}>
                      <div className="float-right pr-[60px]">
                        <button
                          ...
                          className="lg:h-[56px] lg:w-[270px] md:h-[40px] md:w-[220px] h-[30px] w-[180px] rounded-[8px] lg:text-base text-sm bg-primary hover:bg-secondary hover:text-black/80 text-white"
                        >
                          Thanh toán
                        </button>
                      </div>
            ...
            <h1 className="m-6 w-full text-center text-4xl font-semibold">
