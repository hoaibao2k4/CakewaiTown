...
//   };
//   return (
//     <div className="mb-10 mt-16 min-h-screen w-full">
...
//                   {(newItem?.price * newItem?.buy_quantity || totalAmount).toLocaleString('vi-VN') + ' VND'}
//                 </span>
//               </div>
...
//                   disabled={!(newItem || list.length)}
//                   className="w-full rounded-lg border bg-primary py-3 text-xl font-normal text-slate-100 hover:border-primary hover:bg-secondary hover:text-black disabled:border-none disabled:bg-gray-400 disabled:text-white/60"
//                 >
//                   Đặt hàng
//                 </button>
//               </div>
