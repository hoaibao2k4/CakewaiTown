...
const signInForm = () => {
  ...
  useEffect(() => {
    if (window.innerWidth >= 1024) window.scrollTo({ top: 93, behavior: "smooth" });
  }, [pathname]);
...
>
    <div className=" flex flex-col justify-center items-center   min-h-[calc(100vh-15rem)] md:min-h-[calc(100vh-25rem)] lg:min-h-[calc(100vh-36rem)] py-2 md:py-4 lg:py-8  lg:justify-start  ">
        <Head>
            ...
            <meta name="description" content="Đăng nhập để truy cập tài khoản của bạn." />
        </Head>
        <div className="flex flex-col justify-center items-center   min-h-[calc(100vh-15rem)] md:min-h-[calc(100vh-25rem)] lg:min-h-[calc(100vh-36rem)] py-2 md:py-4 lg:py-8  lg:justify-start  ">
        ...
        <h2 className="my-4 text-center text-3xl font-semibold">Đăng nhập</h2>
            ...
            <form onSubmit={handleSubmit} 
                ...
                <div className="relative my-3">
                    ...
                    <i className="absolute right-2 top-1/2 mx-1 -translate-y-1/2 cursor-pointer hover:text-slate-900"
                ...
                <div className="relative flex w-full max-w-[20rem] justify-between text-sm font-light">
                    ...
                    <Link href="/authentic/recovery_email" className="text-slate-600 hover:text-black hover:underline"                >
                        Quên mật khẩu?
                    </Link>
                </div>
            ...
            <button
                onClick={() => (window.location.href = `${BE_BASE_URL}/api/public/google/login`)}
            ...
            <div className="flex w-full justify-center gap-1 pt-2 text-base font-light">
                Chưa có tài khoản? <Link href="/authentic/signUp" className="hover:text-blue-700">Đăng ký</Link>
            </div>
            </div>
        </div>
    </div>
