...
const newsfeedData_onpage = [
  ...
  },
  {
    ...
    description:
      "Bánh cookies mừng thọ là món quà đầy ý nghĩa, mang theo tình cảm chân thành và lời chúc sức khỏe, trường thọ gửi đến ông bà trong ngày đặc biệt.",    author: "CakewaiTown",
  },
  {
    id: "news24",
  ...
  },
  {
    ...
    description:
      "Bánh giỏ quýt với vị ngọt thanh của quýt và lớp vỏ mềm mịn sẽ là món bánh tuyệt vời để bạn tự tay thực hiện tại nhà. Cùng CakewaiTown vào bếp nhé!",    author: "CakewaiTown",
  },
  ...
  },
  {
    ...
    description:
      "Nếu bạn là tín đồ của những chiếc bánh vừa đẹp mắt vừa tinh tế, chắc chắn Entremet sẽ khiến bạn mê mẩn! Xuất phát từ nền ẩm thực Pháp, Entremet là dòng bánh mousse nhiề,...",
    author: "CakeWaiTown",
  },
  {
    id: "news7",
    ...
    description:
      "CaKewaiTown xin chân thành cảm ơn sự quan tâm và ủng hộ từ quý khách hàng trong thời gian qua, đó là động lực to lớn thúc đẩy đội ngũ CakewaiTown...",
    author: "CakeWaiTown",
  },
  {
    id: "news8",
    ...
    description:
      "Ngày 14/02 - ngày của tình yêu, hãy dành tặng cho người thương những chiếc bánh thơm ngon như một lời yêu thương n...",
    author: "Gia Mẫn",
  },
  {
    id: "news1",
    ...
    description:
      "CakewaiTown: Thông Báo Lịch Nghỉ Tết Nguyên Đán 2025. Kính Chúc Quý Khách Hàng Năm Mới An Khang...",
    author: "CakeWaiTown",
  },
  {
    id: "news2",
    ...
    description:
      "Ngày 20/11 được xem là ngày lễ lớn trọng đại nhằm tôn vinh vẻ đẹp và sự cống hiến...",
    author: "CakewaiTown",
  },
  {
    id: "news3",
    ...
    description:
      "Happy Women day - 20/10. Dành tặng cho người phụ nữ tôi yêu----- Vẻ đẹp hút hồn của những quý cô được so sánh như bông hoa hồng nở rộ...",
    author: "Gia Mẫn",
  },
  {
    id: "news4",
  ...
  },
  {
    ...
    description:
      "Nhà CakewaiTown đã vô cùng tâm đắc và trau chuốt khi đã chính thức cho ra mắt bộ sưu tập mới đầy màu sắc và mang tính biểu tượng đến...",
    author: "Gia Mẫn",
  },
  {
    id: "news6",
    ...
    description:
      "CakewaiTown cung cấp: Bánh sinh nhật, bánh minicake, bánh sự kiện, tiệc buffet bánh ngọt, tiệc bánh ngọt khai trương, bánh coockies,... liên hệ hotline để được tư...",
    author: "Gia Mẫn",
  },
];
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Cập nhật tin tức mới nhất về CakewaiTown, chương trình khuyến mãi, sự kiện đặc biệt và các mẫu bánh mới nhất."
        />
      ...
      <div className="flex flex-col px-7 md:px-10 lg:px-28 my-24 items-center justify-center text-black text-primary">
        ...
        <h1 className="font-inter mb-10 text-center  text-4xl font-extrabold leading-none text-primary">
          TIN TỨC
        </h1>
        <div className="grid w-full grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 justify-center place-items-center items-stretch ">
          ...
          {displayedNews.map((news) => (
            <div
              key={news.id}
              className="img-scale flex flex-col h-full w-full max-w-[354px] overflow-hidden rounded-xl border-2 transition-transform duration-300 hover:scale-105"
            >
